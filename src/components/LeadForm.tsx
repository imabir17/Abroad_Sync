...
export function LeadForm({ counselors, isAdminOrManager, stages = [] }: { counselors: Counselor[], isAdminOrManager: boolean, stages?: any[] }) {
  ...
  return (
    <form action={formAction} className="space-y-8">
      {state?.error && (
        <div className="flex items-center gap-2.5 text-xs text-[#E5484D] bg-[#E5484D]/8 p-4 rounded-xl shadow-sm border border-[#E5484D]/10">
      ...
      <div className="bg-blue-50 border-4 border-white rounded-[2rem] shadow-[8px_8px_16px_rgba(0,0,0,0.05),inset_2px_2px_4px_rgba(255,255,255,0.7),inset_-2px_-2px_4px_rgba(0,0,0,0.05)] p-6 relative">
        ...
        {duplicateWarning && (
          <div className="absolute top-4 right-4 bg-[#FF7A52]/10 border border-[#FF7A52]/20 text-[#FF7A52] px-3.5 py-1.5 rounded-xl text-xs font-bold flex items-center gap-1.5 animate-in fade-in slide-in-from-top-2">
              ...
              {englishTestStatus === 'Appeared' && (
                <>
                  <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                    <label htmlFor="englishTestType" className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2">Test Type</label>
                    <select 
                  ...
                  <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                    <label htmlFor="englishTestScore" className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2">Overall Score</label>
                    <input 
                      type="text" 
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2">Passing Year</label>
                  <input type="text" name="sscYear" className={inputClass} placeholder="e.g. 2018" />
                </div>
                <div>
                  <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2">Result (GPA)</label>
            ...
            {(lastCompletedStage === 'Bachelors' || lastCompletedStage === 'Masters') && (
              <div className="animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2">Graduation Year</label>
                    <input type="text" name="bachelorsYear" className={inputClass} placeholder="e.g. 2024" />
                  </div>
                  <div>
                    <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-2">CGPA</label>
      ...
      <div className="bg-orange-50 border-4 border-white rounded-[2rem] shadow-[8px_8px_16px_rgba(0,0,0,0.05),inset_2px_2px_4px_rgba(255,255,255,0.7),inset_-2px_-2px_4px_rgba(0,0,0,0.05)] p-6">
        ...
        <div>
          ...
          <textarea 
            ...
            placeholder="e.g. 2 years at TechCorp as a Software Engineer..."
          ></textarea>
        </div>
      </div>
